package ua.nure.kn.potapov.usermanagement;
...
public class UserTest {
    ...
    //Test 1: тест на имя
    private static final String FIRST_NAME = "Dmitriy";
    private static final String LAST_NAME = "Potapov";
    private static final String FULL_NAME_ETALONE = "Potapov, Dmitriy";
