...
import ua.nure.kn.potapov.usermanagement.web.AddServlet;

import java.text.DateFormat;
import java.util.Date;

public class AddServletTest extends ua.nure.kn.potapov.usermanagement.web.MockServletTestCase {
    @Override
    ...
    public void testAdd() {
        Date date = new Date();
        User newUser = new User("Dmitriy", "Potapov", date);
