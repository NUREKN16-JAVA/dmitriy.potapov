...
import ua.nure.kn.potapov.usermanagement.web.BrowseServlet;

public class BrowseServletTest extends ua.nure.kn.potapov.usermanagement.web.MockServletTestCase {
    ...
    public void testBrowse() {
        User user = new User(new Long(1000),"Dmitriy", "Potapov", new Date());
